def solve_part1_slow(input: str) -> int:
    """Computes the final floor using a slow loop."""
    floor = 0
    for c in input:
...
def solve_part1_fast(input: str) -> int:
    """Computes the final floor using string count for faster computation."""
    return input.count('(') - input.count(')')


def solve_part2_slow(input: str) -> int:
    """
    Finds the position of the first character that causes entry into the basement
